...
public class RequestParser {
  ...
  public Request parse(Message message) throws InvalidRequestException {
    byte[] rawRequest = message.getData();
    ...
    builder.setLocalHost(message.getLocalHost());
    builder.setLocalPort(message.getLocalPort());
    builder.setRemoteHost(message.getRemoteHost());
    builder.setRemotePort(message.getRemotePort());
