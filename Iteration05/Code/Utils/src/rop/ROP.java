...
/**
 * Partial implementation of the Railway Oriented paradigm for error handling.
...
public class ROP<I, S, F> {
	/**
	 * transforms a function that accepts a single argument (I) and returns a
	 * Result<S, F> (switch function) into a function that accepts a Result<I, F>
	 * and returns a Result<S, F> (two-track function)
	 * 
	...
	/**
	 * Transforms a simple function that takes an argument (I) and returns a value
	 * (S) into a switch function that accepts I and return Result<S, F>. Will
	 * always succeed.
	 * 
	...
	/**
	 * combine two switch functions (accept I and return Result<S, F>) into a
	 * single switch containing both functions (accepts S and returns Result<S,
	 * F>).
	 * 
	 * @param s1
	 * @param s2
	...
	/**
	 * transforms a single-track function (accepts I and returns S) into a
	 * two-track function that accepts Result<I, F> and returns Result<S, F>. Will
	 * always Succeed.
	 * 
	 * @param oneTrackFunction
	 * @return
	 */
	...
	/**
	 * transforms a dead-end, single-track function a.k.a. a Consumer (accepts I,
	 * returns nothing) into a single-track function (accepts S, returns S).
	 * 
