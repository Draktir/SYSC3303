...
public class TransferStateBuilder {
	...
	/**
	 * Creates a new instance of the transfer state builder with values from the
	 * given state already set.
	 * 
	 * @param state
	 * @return
	 */
	...
	/**
	 * Applies the values from the given state to this builder, but retains values
